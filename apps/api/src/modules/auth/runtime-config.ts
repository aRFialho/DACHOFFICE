...
const positiveInteger = (value: string | undefined, fallback: number, key: string): number => {
...
export const loadAuthRuntimeConfig = (environment: Environment): AuthRuntimeConfig => {
  ...
  return {
    ...
    tokenConfig: {
      ...
      audience: environment.JWT_ACCESS_AUDIENCE?.trim() || 'dachbyte-office-web',
      accessTokenSecret,
