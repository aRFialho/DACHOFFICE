...
import { createOfficeService, type OfficeRepository } from '../src/modules/admin/office-service.js';
...
describe('OfficeService', () => {
  it('creates an analytical Office with valid working hours', async () => {
    ...
    ).resolves.toMatchObject({ id: 'office-1', name: 'Dachbyte', trustLevel: 'analytical' });
  });
