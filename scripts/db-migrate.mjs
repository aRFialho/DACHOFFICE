...
try {
  ...
  for (const migration of migrations) {
    const applied = await client.query('SELECT 1 FROM schema_migration WHERE version = $1', [migration]);
    ...
    try {
      ...
      await client.query('INSERT INTO schema_migration (version) VALUES ($1)', [migration]);
